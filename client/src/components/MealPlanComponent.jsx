...
const MealPlanComponent = ({ pcodProbability }) => {
  ...
  const generateMealPlan = async (e) => {
    ...
    setLoading(true);
    try {
      const apiKey = import.meta.env.VITE_GEMINI_API_KEY_MEAL;
  ...
  const generateFallbackMealPlan = () => {
    ...
    const mealOptions = {
      ...
      vegan: {
        breakfasts: [
          "Oatmeal made with almond milk, topped with walnuts and berries",
          "Chia seed pudding with coconut milk and mixed fruits",
          "Tofu scramble with spinach, mushrooms, and whole grain toast",
          "Quinoa porridge with flaxseeds and cinnamon",
          "Smoothie bowl with spinach, banana, and hemp seeds",
          "Avocado toast on sourdough with lemon and chili flakes",
          "Buckwheat pancakes with maple syrup and fruit compote"
        ],
        lunches: [
          "Lentil and vegetable stew with a side salad",
          "Quinoa salad with roasted sweet potatoes, black beans, and lime dressing",
          "Chickpea and spinach curry with brown rice",
          "Large mixed salad with crispy baked tofu and tahini dressing",
          "Whole grain wrap filled with hummus, grated carrots, and greens",
          "Black bean and corn salad with a light vinaigrette",
          "Vegetable stir-fry with edamame and quinoa"
        ],
        dinners: [
          "Baked eggplant stuffed with vegetables and quinoa",
          "Zucchini noodles with a rich lentil and tomato bolognese",
          "Thai green vegetable curry with brown rice",
          "Stuffed bell peppers with black beans, corn, and spices",
          "Hearty minestrone soup with whole grain bread/crackers",
          "Roasted cauliflower and chickpea bowl with lemon-tahini dressing",
          "Sweet potato and black bean chili"
        ],
        snacks: [
          "Apple slices with peanut butter",
          "Handful of mixed nuts (almonds, walnuts) and pumpkin seeds",
          "Carrot and celery sticks with hummus",
          "Soy yogurt with a sprinkle of berries",
          "Spicy roasted chickpeas",
          "Edamame pods with sea salt",
          "Homemade energy bites (dates, oats, and nuts)"
        ]
      },
      "non-vegetarian": {
        breakfasts: [
          ...
          "Oatmeal with nuts and berries",
          "Two boiled eggs with half an avocado",
          "Greek yogurt with flaxseeds and mixed fruits",
          "Omelet with mushrooms, bell peppers, and a side of tomatoes",
          "Whole grain pancakes with fruit compote",
          "Smoked salmon and cream cheese on a small whole wheat bagel"
        ],
        lunches: [
          "Grilled chicken breast salad with mixed greens and olive oil dressing",
          "Quinoa bowl with roasted vegetables and sliced turkey",
          "Chicken and vegetable soup with a slice of whole grain bread",
          "Tuna salad wrap using a whole grain tortilla",
          "Baked salmon fillet with a side of steamed broccoli and sweet potato",
          "Lentil and chicken stew",
          "Chicken stir-fry with plenty of vegetables and brown rice"
        ],
        dinners: [
          "Baked chicken thighs with roasted Brussels sprouts and carrots",
          "Zucchini noodles with lean ground turkey bolognese",
          "Grilled fish (like cod or tilapia) with asparagus and quinoa",
          "Chicken and vegetable curry with a small portion of brown rice",
          "Lean beef or chicken chili with beans",
          "Stuffed bell peppers with ground turkey and brown rice",
          "Roasted chicken breast with a large side salad"
        ],
        snacks: [
          "Apple slices with almond butter",
          "Handful of mixed nuts and seeds",
      ...
      pescatarian: {
        breakfasts: [
          ...
          "Smoked salmon on whole grain toast with cucumber slices",
          "Spinach and mushroom omelet",
          "Greek yogurt with flaxseeds and assorted fruits",
          "Chia seed pudding made with almond milk",
          "Avocado toast with cherry tomatoes and a sprinkle of hemp seeds",
          "Two boiled eggs with a side of mixed fruit"
        ],
        lunches: [
          "Grilled salmon salad with mixed greens and a lemon-olive oil dressing",
          "Tuna salad (made with Greek yogurt instead of mayo) on whole grain bread",
          "Lentil soup with a small side salad",
          "Quinoa bowl with roasted vegetables and shrimp",
          "Whole grain wrap with hummus, plenty of vegetables, and grilled fish",
          "Shrimp and vegetable stir-fry with brown rice",
          "Greek salad with feta cheese and baked cod"
        ],
        dinners: [
          "Baked tilapia or cod with roasted asparagus and sweet potato wedges",
          "Zucchini noodles with a tomato and shrimp sauce",
          "Vegetable and chickpea curry with brown rice",
        ...
        snacks: [
          "Apple slices with almond butter",
          "Handful of mixed nuts (almonds, walnuts) and seeds",
